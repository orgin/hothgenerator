	...
	public void populate(World world, Random random, Chunk chunk)
	{
		...
		for(int x=0;x<16;x++)
		{
			for(int z=0;z<16;z++)
			{
				...
				if(downType.equals(Material.GRASS))
				{
					...
					if(dograss>3 && dograss<8)
					{
						...
						else
						{
							...
							LongGrass grass = (LongGrass)state.getData();
							grass.setSpecies(species);
							state.update(true, false);
						}
					}
				...
				else if(downType.equals(Material.MYCEL))
				{
