...
public class TatooineSarlaccPopulator extends BlockPopulator
{
	...
	public void populate(World world, Random random, Chunk chunk)
	{
		if(this.schematic!=null)
		{
			...
			int rarity = plugin.getStructureSarlaccRarity(world);
	...
	private int getSurfaceLevel(Block block)
	{
		...
		while(block.getY()>5 && !type.equals(Material.SAND) && !type.equals(Material.SANDSTONE) && !type.equals(Material.STATIONARY_WATER))
		{
